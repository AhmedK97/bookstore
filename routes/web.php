...
Route::get('/book/{book}', [BooksController::class, 'details'])->name('books.details');
Route::post('/book/{book}/rate', [BooksController::class, 'rate'])->name('book.rate');

Route::get('/Category/{category}',  [CategoriesController::class, 'result'])->name('gallery.categories.show');
