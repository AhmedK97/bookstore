...
<body dir="rtl">
    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-wight">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">مكتبة المعرفة</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="mx-auto navbar-nav">
                        ...
                        @endauth
                        <li class="nav-item">
                            <a class="text-center nav-link" href="{{ route('gallery.categories.index') }}">التصنيفات
                                <i class="fas fa-list"></i>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="text-center nav-link" href="{{ route('gallery.publishers.index') }}">الناشرون
                                <i class="fas fa-table"></i>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="text-center nav-link" href="{{ route('gallery.authors.index') }}">المؤلفون
                        ...
                        <li class="nav-item">
                            <a class="text-center nav-link" href="{{ route('my.product') }}">مشترياتي
                    ...
                    <ul class="mr-auto navbar-nav">
                        ...
                        <li class="nav-item dropdown justify-content-left">
                            ...
                            <div class="px-2 mt-2 text-right dropdown-menu dropdown-menu-left">
                                @can('update-books')
                                <a href='{{route('admin.index')}}' class="dropdown-item">لوحه التحكم</a>
                                @endcan
    ...
    <script src="https://kit.fontawesome.com/f8f675a4fd.js" crossorigin="anonymous"></script>
