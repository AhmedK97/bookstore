            ...
            <div class="card-body" style="padding:0">
                <table class="table table-striped">
                    ...
                    <div class="mb-2 text-center form" >
                        ...
                        <span class="mb-3 text-muted"><input class="mx-auto form-control d-inline" id="quantity" name="quantity" type="number" value="1" min="1" max="{{ $book->number_of_copies }}" style="width:10%;" required></span>
                ...
                @endauth
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span>عدد المقيمن للكتاب : {{ $book->ratings()->count() }}</span>
                        </td>
                    </tr>
                    @if ($book->isbn)
                    <tr>
                    ...
                    <tr>
                        <th>صورة الغلاف</th>
                        <td class="aline-center:center"> <img class='mx-auto rounded img-fluid img-thumbnail d-block'
                                 src="{{ asset('storage/' . $book->cover_image) }}" width="600px" height="600px" alt=""> </td>
                    </tr>
                    @if ($book->category)
                    <tr>
                        <th>التصنيف</th>
                ...
                <div class="alert alert-info mt-4" role="alert">
                    يجب عليك شراء الكتاب لتستطيع تقيمه
                </div>
                @endif
