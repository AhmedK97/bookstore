...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        $book1 = Book::create([
            ...
            'publisher_id' => Publisher::where('name', 'مكتبه المعرفه')->first()->id,
        ...
        $book1->authors()->attach(Author::where('name', 'غادة السمّان')->first());
        ...
        $book2->authors()->attach(Author::where('name', 'أحلام مستغانمي')->first());
        ...
        $book3->authors()->attach(Author::where('name', 'الطيب صالح')->first());
        ...
        $book4->authors()->attach(Author::where('name', 'عبد الرحمن منيف')->first());

        $book5 = Book::create([
            'category_id' => Category::where('name','التتسويق والمبيعات')->first()->id,
            'publisher_id' => Publisher::where('name', 'مكتبه المعرفه')->first()->id,
        ...
        $book5->authors()->attach(Author::where('name', 'رجاء الصانع')->first());
        ...
        $book6->authors()->attach(Author::where('name', 'رضوى عاشور')->first());
    }
}
